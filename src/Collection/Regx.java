...
public class Regx {
	...
	public static void main(String[] args) {
		...
		pat = Pattern.compile("\\D"); // represents anything but numbers (single
		// char)
		mat = pat.matcher("@");
		System.out.println("For \\D:" + mat.matches());
		...
		pat = Pattern.compile("\\S"); // represents anything but space(single
		// char)
		mat = pat.matcher("$");
		System.out.println("For \\S:" + mat.matches());
		...
		pat = Pattern.compile("\\W"); // represents anything but char (special
		// char)
		mat = pat.matcher("!");
		System.out.println("For \\W:" + mat.matches());

		pat = Pattern.compile("\\W+"); // represents anything but chars (special
		// chars)
		mat = pat.matcher("!!$^#(");
		System.out.println("For \\W+:" + mat.matches());
